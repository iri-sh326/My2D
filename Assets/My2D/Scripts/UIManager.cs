...
namespace My2D
{
    public class UIManager : MonoBehaviour
    {
        ...
        {
            // damageTextPrefab 스폰
            Vector3 spawnPosition = Camera.main.WorldToScreenPoint(character.transform.position + healthTextOffset);
        ...
        public void CharacterHealed(GameObject character, float restore)
        {
            ...
            GameObject textGo = Instantiate(healTextPrefab, spawnPosition, Quaternion.identity, canvas.transform);
